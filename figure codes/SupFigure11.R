...
ggsave("figures/supfigure11_legend.tif", plot=last_plot(), device="tiff", width=12.8, height=4.3, units="in", dpi=320, bg="white")
...
ggsave("figures/supfigure11.tif", plot=last_plot(), device="tiff", width=26, height=12, units="in", dpi=320, bg="white")
