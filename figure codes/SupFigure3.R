...
plot(p1)
ggsave("figures/figure3A_legend.tif", plot=last_plot(), device="tiff", width=11.83, height=3.25, units="in", dpi=320, bg="white")

plot(p2)
ggsave("figures/figure3B_legend.tif", plot=last_plot(), device="tiff", width=11.83, height=3.25, units="in", dpi=320, bg="white")


ggarrange(p1_nolegend, ggarrange(p2_nolegend,p3,ncol=2), nrow=2)
ggsave("figures/SupFigure3.tif", plot=last_plot(), device="tiff", width=11.83, height=6.53, units="in", dpi=320, bg="white")
