...
tiff(file="figures/supfigure7B.tif", height=6.74, width=8.9, units="in", res=320)
print(myplot)
dev.off()
...
ggsave("figures/supfigure7.tif", plot=last_plot(), device="tiff", width=12.8, height=6.64, units="in", dpi=320, bg="white")
