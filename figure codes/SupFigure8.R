...
contrast_in="CD4 T lymphocyte vs B lymphocyte"
...
tiff(file="figures/supfigure8B.tif", height=6.74, width=8.9, units="in", res=320)
print(myplot)
dev.off()
...
#ggsave("figures/figure8C.tif", plot=last_plot(), device="tiff", scale=6, width=40, height=20, units="mm", dpi=320, bg="white")


library(ggpubr)
ggarrange(ggarrange(p1, p2, p3, p4, ncol=2, nrow=2), ggarrange(NULL,p5, nrow=2), ncol=2)
ggsave("figures/supfigure8.tif", plot=last_plot(), device="tiff", width=12.8, height=6.64, units="in", dpi=320, bg="white")
