...
idx_up=which(sig_df[,1]=="sig up")
idx_down=which(sig_df[,1]=="sig down")
est_comb=est_comb[c(idx_up, idx_down),]


write.csv(est_comb, file="figures/resub/miRglmm_sig_miRNA.csv")
